...
if __name__ == "__main__":
    ...
    print()
    print("Erster Graph Darstellung:", ist_graphs[0])
    print()
    print("Erster Graph - Daten:")
    ...
    print("Graph-ID:", ist_graphs[0].graph_id)
    print("Pattern (Attribute):", ist_graphs[0].graph_attrs)